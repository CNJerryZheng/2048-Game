...
QColor tileBackground(int value)
{
    ...
    case 4: return {232, 217, 186};
    case 8: return {231, 178, 125};
    case 16: return {232, 152, 107};
    case 32: return {230, 127, 98};
    case 64: return {227, 99, 66};
    case 128: return {236, 208, 105};
    case 256: return {237, 212, 115};
    case 512: return {239, 202, 87};
    case 1024: return {240, 200, 78};
...
QString applicationStyleSheet()
{
    return QStringLiteral(
        ...
        "QLineEdit,QSpinBox,QTextEdit{padding:9px;border:1px solid #bbada0;border-radius:6px;"
        "background:#ffffff;color:#3c3a32;selection-background-color:#8f7a66;"
        "selection-color:#ffffff;}"
        "QLineEdit:focus,QSpinBox:focus,QTextEdit:focus{border:2px solid #8f7a66;}"
